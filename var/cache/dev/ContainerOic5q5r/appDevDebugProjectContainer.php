...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('U4r2tW9K-O', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3OQdY3LCMn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JISjzLCMkF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Sak8OHBW+9', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\Nosotros\\NosotrosBundle/Resources/views'), 'NosotrosNosotros');
        $instance->addPath(($this->targetDirs[3].'\\src\\Nosotros\\NosotrosBundle/Resources/views'), '!NosotrosNosotros');
        $instance->addPath(($this->targetDirs[3].'\\src\\NosotrosII\\nosotrosBundle/Resources/views'), 'NosotrosIInosotros');
        $instance->addPath(($this->targetDirs[3].'\\src\\NosotrosII\\nosotrosBundle/Resources/views'), '!NosotrosIInosotros');
        $instance->addPath(($this->targetDirs[3].'\\src\\Contactar\\ContactarBundle/Resources/views'), 'ContactarContactar');
        $instance->addPath(($this->targetDirs[3].'\\src\\Contactar\\ContactarBundle/Resources/views'), '!ContactarContactar');
        $instance->addPath(($this->targetDirs[3].'\\src\\Tapas\\TapasBundle/Resources/views'), 'TapasTapas');
        $instance->addPath(($this->targetDirs[3].'\\src\\Tapas\\TapasBundle/Resources/views'), '!TapasTapas');
        $instance->addPath(($this->targetDirs[3].'\\src\\Inicio\\inicioBundle/Resources/views'), 'Inicioinicio');
        $instance->addPath(($this->targetDirs[3].'\\src\\Inicio\\inicioBundle/Resources/views'), '!Inicioinicio');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'NosotrosNosotrosBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Nosotros\\NosotrosBundle'),
                    'namespace' => 'Nosotros\\NosotrosBundle',
                ],
                'NosotrosIInosotrosBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\NosotrosII\\nosotrosBundle'),
                    'namespace' => 'NosotrosII\\nosotrosBundle',
                ],
                'ContactarContactarBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Contactar\\ContactarBundle'),
                    'namespace' => 'Contactar\\ContactarBundle',
                ],
                'TapasTapasBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Tapas\\TapasBundle'),
                    'namespace' => 'Tapas\\TapasBundle',
                ],
                'InicioinicioBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Inicio\\inicioBundle'),
                    'namespace' => 'Inicio\\inicioBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'NosotrosNosotrosBundle' => 'Nosotros\\NosotrosBundle\\NosotrosNosotrosBundle',
                'NosotrosIInosotrosBundle' => 'NosotrosII\\nosotrosBundle\\NosotrosIInosotrosBundle',
                'ContactarContactarBundle' => 'Contactar\\ContactarBundle\\ContactarContactarBundle',
                'TapasTapasBundle' => 'Tapas\\TapasBundle\\TapasTapasBundle',
                'InicioinicioBundle' => 'Inicio\\inicioBundle\\InicioinicioBundle',
